...
import { cvFileName, cvUrl, downloadCv } from '@/lib/cvDownload';
        ...
        <div ref={ref} className={`max-w-3xl stagger-children ${isVisible ? 'visible' : ''}`}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
            {[
              ...
              { icon: Globe2, label: 'Website', value: 'elsilveira.github.io/eduardosilveira', href: 'https://elsilveira.github.io/eduardosilveira/' },
